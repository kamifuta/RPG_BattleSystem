...
{
    public class MagicDefenceDownAttack : SkillData
    {
        public override SkillType skillType => SkillType.MagicDefenceDownAttack;
        public override string skillName => "–‚–@–hŒä‰º‚°UŒ‚";
        public override string skillExplane => "UŒ‚‚µ‚½‘ÎÛ‚Ì–‚–@–hŒä—Í‚ðŠm—¦‚Å‰º‚°‚é";
