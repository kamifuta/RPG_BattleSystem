...
namespace PCGs
{
    public class Learning : IStartable, IDisposable
    {
        ...
        private readonly int battleTimes = 100;
        ...
        [Inject]
        public Learning(CharacterManager characterManager, EnemyFactory enemyFactory, PlayerAgentFactory playerAgentFactory)
        {
